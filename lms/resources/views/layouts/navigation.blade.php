                ...
                <!-- Navigation Links -->
                    @if (Auth::user()->hasRole('manager'))
                        ...
                        <x-dropdown align="center" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('learners.index')">
                                    {{ __('View Learners') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('profile.edit')">
                                    {{ __('Add Learner') }}
                    ...
                    <x-nav-link :href="route('learner.training-plan')" :active="request()->routeIs('learner.training-plan')">Training Plan</x-nav-link>
